...
features_incorporated = '[{"name":"multipart-upload","base":"v5.10.0"}]'

oarepo_major_version = "12"

package_oarepo_version = "oarepo-5.10.1"

configuration = '{"name": "invenio-records-resources", "oarepo": 12, "features": [{"name": "multipart-upload", "base": "v5.10.0"}], "package": "invenio-records-resources", "invenio_version": "5.10.1", "version": "5.10.1"}'
