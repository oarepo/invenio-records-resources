...
features_incorporated = '[{"name":"kwargs-from-8.6.0","base":"v8.6.0"}]'

oarepo_major_version = "13"

package_oarepo_version = "oarepo-8.6.0"

configuration = '{"name": "invenio-records-resources", "oarepo": 13, "features": [{"name": "kwargs-from-8.6.0", "base": "v8.6.0"}], "package": "invenio-records-resources", "invenio_version": "8.6.0", "version": "8.6.0"}'
