...
class RecordService(Service, RecordIndexerMixin):
    ...
    def scan(
        ...
        self.require_permission(identity, "search", params=params, expand=expand, **kwargs)
    ...
    def reindex(
        ...
        **kwargs,
        ...
        self.require_permission(identity, "search", params=params,
                                search_query=search_query, extra_filter=extra_filter, **kwargs)
    ...
    def create(self, identity, data, uow=None, expand=False, **kwargs):
        ...
        """
        return self._create(self.record_cls, identity, data, uow=uow, expand=expand, **kwargs)

    @unit_of_work()
    def _create(
        self, record_cls, identity, data, raise_errors=True, uow=None, expand=False, **kwargs
    ):
        """Create a record.
