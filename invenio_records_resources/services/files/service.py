...
class FileService(Service):
    ...
    def update_file_metadata(self, identity, id_, file_key, data, uow=None, **kwargs):
        ...
        """
        record = self._get_record(id_, identity, "create_files", file_key=file_key, data=data, **kwargs)
    ...
    def read_file_metadata(self, identity, id_, file_key, **kwargs):
        ...
        :raises FileKeyNotFoundError: If the record has no file for the ``file_key``
        """
        record = self._get_record(id_, identity, "read_files", file_key=file_key, **kwargs)
    ...
    def extract_file_metadata(self, identity, id_, file_key, uow=None, **kwargs):
        ...
        :raises FileKeyNotFoundError: If the record has no file for the ``file_key``
        """
        record = self._get_record(id_, identity, "create_files", file_key=file_key, **kwargs)
    ...
    def commit_file(self, identity, id_, file_key, uow=None, **kwargs):
        ...
        :raises FileKeyNotFoundError: If the record has no file for the ``file_key``
        """
        record = self._get_record(id_, identity, "commit_files", file_key=file_key, **kwargs)
    ...
    def delete_file(self, identity, id_, file_key, uow=None, **kwargs):
        ...
        :raises FileKeyNotFoundError: If the record has no file for the ``file_key``
        """
        record = self._get_record(id_, identity, "delete_files", file_key=file_key, **kwargs)
    ...
    def set_file_content(
        ...
        record = self._get_record(id_, identity, "set_content_files", file_key=file_key,
                                  stream=stream, content_length=content_length, **kwargs)
        errors = None
        try:
            self.run_components(
                "set_file_content",
    ...
    def get_file_content(self, identity, id_, file_key, **kwargs):
        ...
        :raises FileKeyNotFoundError: If the record has no file for the ``file_key``
        """
        record = self._get_record(id_, identity, "get_content_files", file_key=file_key, **kwargs)
